...
class PresetRegistry:
    ...
    def _merge_decorator_presets(
        ...
        *,
        ...
        from app.modules.presets._registry import list_presets as _list_deco
    ...
    def _get_decorator_preset(preset_id: str) -> PresetSpec | None:
        from app.modules.presets._registry import get_preset_meta
    ...
    def _decorator_meta_to_spec(meta: Any) -> PresetSpec:
        ...
        from app.modules.presets.schema import (
            CompatConfig,
            IOConfig,
            ModelSource,
            OwnershipConfig,
