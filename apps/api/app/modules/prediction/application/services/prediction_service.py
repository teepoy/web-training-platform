...
class PredictionService:
    ...
    async def _resolve_predictor(
        ...
        """
        from app.modules.presets.registry import PresetRegistry as _OldRegistry
    ...
    async def run_prediction(
        ...
        * ``file_shard_sparse`` (future) — will dispatch to
        ...
        #
        # Integration point:
        #   from app.modules.prediction.application.services.sparse_prediction import SparsePredictionRunner
