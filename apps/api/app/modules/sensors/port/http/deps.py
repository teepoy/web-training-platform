...
from app.modules.sensors.app.services.sensor_dispatch import (
...
def get_sensor_repository(request: Request) -> SensorRepository:
    return request.app.state.app_context.sensors.sensor_repository
...
def get_sensor_registry(request: Request) -> SensorRegistry:
    return request.app.state.app_context.sensors.sensor_registry
