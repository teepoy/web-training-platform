...
from libs.ml.domain import BatchPredictResult, ModelRef, PredictContext, PredictResult

if TYPE_CHECKING:
    from libs.ml.protocols import EmbeddingClient
