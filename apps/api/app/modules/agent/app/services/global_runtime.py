...
from app.modules.agent.adapter.tools.global_tools import (
...
from app.modules.agent.port.http.schemas import AgentContext
...
class GlobalAgent:
        ...
        *,
        ...
        try:
            ...
            if name == "list_trainers":
                return await execute_list_trainers()
            if name == "list_models":
    ...
    def _summarise_tool_call(
        ...
        if name == "get_training_job":
            ...
            if name == "list_trainers":
                return f"Listed {result.get('count', '?')} trainers"
        if name == "list_models":
