...
async def global_agent_chat(
    ...
    surface_store: SurfaceStore = Depends(get_surface_store),
    training_submission: TrainingExecutionPort = Depends(get_training_submission),
    prediction_submission: PredictionExecutionPort = Depends(get_prediction_submission),
    ...
    agent = GlobalAgent(
        ...
        training_submission=training_submission,
