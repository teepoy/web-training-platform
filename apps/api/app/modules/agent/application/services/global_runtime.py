...
from litellm.types.llms.openai import AllMessageValues, ChatCompletionToolMessage  # type: ignore[import-untyped]

from app.modules.agent.infrastructure.tools.global_assembler import (
    assemble_global_prompt,
)
from app.modules.agent.infrastructure.tools.global_tools import (
...
from app.modules.agent.interfaces.dtos.schemas import AgentContext
    ...
    async def handle_message(
        ...
        *,
        ...
        if context.dataset_id:
            try:
                from app.modules.agent.infrastructure.tools.global_tools import (
                    execute_get_dataset as _get_ds,
                )
