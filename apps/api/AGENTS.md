...
| Capability catalogs             | `app/modules/types/catalog.py`, `app/modules/runtime/catalog.py`, module runtime routers             | Type catalog owns views; runtime routers unify trainer/predictor metadata, callables, and algorithms; optional Torch kernels live in `libs/ml`. |
