  ...
  apiMocks: async (
    ...
    const bound: ApiMocks = {
      ...
      datasets: {
        ...
        mockAnnotationStats: (datasetId, stats) =>
          mockAnnotationStats(page, datasetId, stats),
        ...
        mockSampleSimilar: (datasetId, sampleId) =>
          mockSampleSimilar(page, datasetId, sampleId),
        mockDatasetQuery: (datasetId) => mockDatasetQuery(page, datasetId),
        mockDatasetStatus: (datasetId, status) =>
          mockDatasetStatus(page, datasetId, status),
      ...
      schedules: {
        ...
        mockGetSchedule: (scheduleId, schedule) =>
          mockGetSchedule(page, scheduleId, schedule),
      ...
      preview: {
        ...
        mockGetPreviewItems: (sessionId, items) =>
          mockGetPreviewItems(page, sessionId, items),
        ...
        mockExpiredPreviewSession: (sessionId) =>
          mockExpiredPreviewSession(page, sessionId),
      },
      sc: {
        mockScInspections: (overrides) =>
          mockScInspections(page, overrides),
        mockScInspectionSamples: () =>
          mockScInspectionSamples(page),
        mockScDataset: (datasetId, overrides) =>
          mockScDataset(page, datasetId, overrides),
