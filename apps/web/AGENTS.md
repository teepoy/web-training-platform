...
- `ScPatchImageView.vue` maps backend view rows to UI rows and should use canonical SC image helpers when it needs to derive URLs from row identity fields.
