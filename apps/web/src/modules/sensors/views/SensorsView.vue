...
import { listSensors, listSubscriptions, updateSubscription, deleteSubscription } from "@/modules/sensors/api";
import type { SensorDefinition, SensorSubscription } from "@/modules/sensors/types";
