...
import { createSubscription, updateSubscription } from "@/modules/sensors/api";
import type { SensorDefinition, SensorSubscription, CreateSubscriptionBody, UpdateSubscriptionBody } from "@/modules/sensors/types";
