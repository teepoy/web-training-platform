...
function main() {
  ...
  if (dryRun) {
    ...
    console.log(
      `  pending=${e2eCounts["pending"] || 0}, migrated=${e2eCounts["migrated"] || 0}, dropped=${e2eCounts["dropped"] || 0}, total=${allE2E}`,
    );
    console.log("=== Vitest Unit Tests ===");
    console.log(
      `  pending=${vitestCounts["pending"] || 0}, migrated=${vitestCounts["migrated"] || 0}, dropped=${vitestCounts["dropped"] || 0}, total=${allVitest}`,
    );
    ...
    console.log(
      `=== Overall: pending=${totalPending}, migrated=${totalMigrated}, dropped=${totalDropped}, total=${allE2E + allVitest}`,
    );
  }
