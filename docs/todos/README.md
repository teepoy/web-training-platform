...
| [Stateful upstream simulator](stateful-upstream-simulator-and-source-automation.md) | In progress | Separate package, initial PostgreSQL migration, and publication model | Add the authenticated HTTP control API and thin CLI             |
