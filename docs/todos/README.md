...
| [Numeric and date range filter controls](range-filter-input-controls.md)                                              | Complete    | Shared numeric slider and typed DateTime Range Picker states verified                    | —                                          |
...
| [SC identity-only materialization](sc-sample-identity-only-materialization.md)                                        | In progress | Bounded identity-only latest-source resolution verified                                  | Decide legacy Backfill and payload cleanup |
