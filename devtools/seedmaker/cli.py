...
def main() -> int:
    ...
    parser.add_argument("--sc-imaged-defects", type=int, default=100)
    parser.add_argument("--sc-images-per-defect", type=int, default=5)
    parser.add_argument("--sc-gallery-defects", type=int, default=64)
    parser.add_argument("--sc-gallery-imaged-defects", type=int, default=8)
    parser.add_argument("--sc-defects-per-archive", type=int, default=500)
    parser.add_argument("--sc-append-batch-size", type=int, default=500)
