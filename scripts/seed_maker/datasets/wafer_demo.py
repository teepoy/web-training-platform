...
from seed_maker.utils import api_request, _find_by_name
...
def run(args, runner: SeedRunner) -> int:
    ...
    runner.upload_samples(total=samples, item_builder=build_sample_item, batch_size=batch_size)
    runner.summary()
    return 0
