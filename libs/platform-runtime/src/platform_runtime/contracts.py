"""Stable runtime contracts shared by API, worker, and ML runtimes.

This module is intentionally lightweight: only stdlib dataclasses, typing
Protocols, and DTO shapes that cross process/package boundaries live here.
Do not import application packages, database ORM models, web frameworks, or ML
frameworks from this module.
"""
...
@dataclass
class TrainRequest:
    """Client DTO for submitting a training job to a runtime worker."""
