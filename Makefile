...
help: ## Show this help message
	...
	@printf '    \033[36m%-43s\033[0m %s\n' "PROFILES" "Compose profile flags forwarded by production wrapper targets"
	...
	@printf '    \033[36m%-43s\033[0m %s\n' "PROD_PLATFORM_ENV" "Production platform environment file"
	@printf '    \033[36m%-43s\033[0m %s\n' "PROD_OBSERVABILITY_ENV" "Production observability environment file"
	@printf '\n  Canonical release workflow\n'
	@printf '    \033[36m%-43s\033[0m %s\n' "RELEASE_PROFILE" "Application profile for direct release targets: pre-release or prod"
	@printf '    \033[36m%-43s\033[0m %s\n' "RELEASE_NETWORK" "External Docker network used by the selected release"
	@printf '    \033[36m%-43s\033[0m %s\n' "RELEASE_PROJECT" "Compose project-name prefix for the selected release"
	@printf '    \033[36m%-43s\033[0m %s\n' "RELEASE_STATEFUL_ENV" "Stateful-services environment file for direct release targets"
	@printf '    \033[36m%-43s\033[0m %s\n' "RELEASE_PLATFORM_ENV" "Platform environment file for direct release targets"
	@printf '    \033[36m%-43s\033[0m %s\n' "RELEASE_IMAGE_ENV" "Optional generated image-digest environment file loaded after platform config"
	@printf '    \033[36m%-43s\033[0m %s\n' "RELEASE_OBSERVABILITY_ENV" "Observability environment file for direct release targets"
	@printf '    \033[36m%-43s\033[0m %s\n' "RELEASE_PROFILES" "Optional Compose profile flags for direct release targets"
